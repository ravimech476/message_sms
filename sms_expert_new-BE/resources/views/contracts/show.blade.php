...
@section('content')
    <div class="contract-view-container">
        ...
        <div class="breadcrumb-container d-flex align-items-center justify-content-between">
            ...
            {{-- <a href="{{ route('contracts.index') }}" class="btn btn-outline-secondary back-btn">
        ...
        <div class="contract-content-card">
                ...
                <div id="tab-file" class="tab-content-section">
                    @if ($isPdf)
                        <div class="pdf-viewer-container">
                            <iframe src="{{ route('contracts.view-file', $contract->id) }}" class="pdf-viewer"></iframe>
                        </div>
                    @endif
                    <div class="file-download-section" style="margin: 1rem;">
                        ...
                        <a href="{{ route('contracts.download', $contract->id) }}" class="btn-download">
                            <i class="material-icons-outlined">download</i>
                            Download Contract
                        </a>
                        @if ($isPdf)
                            <a href="{{ route('contracts.view-file', $contract->id) }}" target="_blank"
                                class="btn-view-pdf">
            ...
            @elseif($hasFile)
                ...
                <div class="file-download-section" style="margin: 1rem;">
                    ...
                    @if ($isPdf)
                        <a href="{{ route('contracts.view-file', $contract->id) }}" target="_blank" class="btn-view-pdf">
                            <i class="material-icons-outlined">open_in_new</i>
                            Open in New Tab
                        </a>
                    @endif
        ...
        @else
            @if ($contract->requires_signature)
                ...
                <div class="signature-section">
                    ...
                    <form action="{{ route('contracts.sign', $contract->id) }}" method="POST" id="signatureForm">
                        @csrf
