...
/* Admin auth card - slightly different styling for admin */
.auth-card {
...
/* Left side branding - admin variant */
.auth-brand {
...
<div class="auth-wrapper">
    <div class="auth-card">
        ...
        <div class="auth-brand">
            ...
            <p class="brand-subtitle">Administrative Access to SMS Expert Platform Management</p>
        ...
        <div class="auth-form">
            <div class="form-header">
                ...
                <p class="form-subtitle">Enter your admin credentials to access the control panel</p>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    <label for="userName" class="form-label">
                        <i class="material-icons-outlined" style="font-size: 1.1rem; color: #ea6118;">admin_panel_settings</i>
                        Admin Username
                    </label>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (loginForm && loginButton) {
        loginForm.addEventListener('submit', function() {
            loginButton.innerHTML = '<div class="loading-spinner"></div>Accessing Admin Panel...';
    ...
    console.log('SMS Expert branded admin login page loaded successfully!');
});
