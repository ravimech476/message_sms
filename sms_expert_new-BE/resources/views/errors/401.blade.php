...
<head>
    ...
    <title>401 - Unauthorized | SMS Expert</title>
    ...
    <style>
        ...
        * {
        ...
        .error-container::before {
            ...
            right: 0;
            height: 5px;
            background: linear-gradient(90deg, var(--rose-color), #e11d48);
        }
        ...
        .error-code {
            font-size: 120px;
            font-weight: 700;
            background: linear-gradient(135deg, var(--rose-color), #e11d48);
...
<body>
    <div class="error-container">
        <span class="decoration">401</span>
        <div class="content">
            <span class="material-icons-outlined error-icon">lock</span>
