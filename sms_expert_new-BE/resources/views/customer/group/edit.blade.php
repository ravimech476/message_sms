...
<style>
    ...
    .btn-outline-secondary-toggle:hover {
        background: #293b50;
        border-color: #293b50;
        color: white;
        transform: translateY(-2px);
    ...
    <div class="breadcrumb-container d-flex align-items-center justify-content-between fade-in">
        <div class="d-flex align-items-center">
            <div class="breadcrumb-title pe-3">
                <i class="material-icons-outlined icon-primary">edit</i>
                Edit Group
            </div>&nbsp;
    ...
    <div class="main-card fade-in">
        ...
        <div class="page-header">
            ...
            <div class="page-subtitle">
                Update your group name and settings
            </div>
        </div>
        ...
        <div class="content-section">
            ...
            <div class="current-group-info">
                <div class="current-group-title">
                    <i class="material-icons-outlined">info</i>
                    Current Group
                </div>
                <div class="current-group-name">{{ $group->name ?? 'Unknown Group' }}</div>
            </div>
            ...
            {{-- <div class="info-section">
                ...
                <p class="info-text">
                    Choose a descriptive name that helps you identify the group easily. 
                    Group names can contain letters, numbers, and special characters. 
                    Keep it concise but meaningful for better organization.
                </p>
            </div> --}}

            <!-- Edit Form -->
            <form action="{{ route('groups.update', $group->id) }}" method="POST" id="editGroupForm">
                @csrf
                @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-icon">
                            ...
                            <input type="text" 
                                   ...
                                   name="group_name" 
                                   required
                                   value="{{ old('group_name', $group->name) }}"
                                   placeholder="Enter group name"
                                   maxlength="100"
                                   autocomplete="off">
                        </div>
                        <div class="character-counter">
                            <span id="charCount">{{ strlen($group->name ?? '') }}</span>/100 characters
                        </div>
                        <div class="form-help-text">
                            <i class="material-icons-outlined" style="font-size: 14px;">info</i>
                            This name will be used to identify your group throughout the SMS Expert platform
                        </div>
                        @error('group_name')
                            <div class="text-danger mt-1">
                                <i class="material-icons-outlined" style="font-size: 14px;">error</i>
                                {{ $message }}
                            </div>
                        @enderror
                    </div>
            ...
            <div class="content-section">
                ...
                <form action="{{ route('update.addressbook') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-actions">
                        <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center">
                            ...
                            <!-- Right Side Action -->
                            <div>
                                <button type="button" name="toggleButton" class="btn btn-outline-secondary-toggle" onclick="doToggleSelect()">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            ...
            if (groupName.length < 2) {
                ...
                groupNameInput.parentElement.style.animation = 'shake 0.5s ease-in-out';
                
                // Create or update error message
                let errorDiv = form.querySelector('.validation-error');
                if (!errorDiv) {
                    errorDiv = document.createElement('div');
                    errorDiv.className = 'validation-error alert alert-danger mt-2 py-2';
                    errorDiv.innerHTML = '<i class="material-icons-outlined me-1">error</i>Group name must be at least 2 characters long';
                    groupNameInput.parentElement.parentElement.appendChild(errorDiv);
                }
                
                setTimeout(() => {
                    groupNameInput.parentElement.style.animation = '';
                }, 500);
    ...
    console.log('Modern Group Edit page loaded successfully!');
});
</script>
<script>
document.addEventListener('DOMContentLoaded', function() {
