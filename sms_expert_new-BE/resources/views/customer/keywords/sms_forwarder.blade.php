@extends('layouts.app')
@section('title', 'SMS Forwarder - SMS Expert')
    ...
    <div class="config-container">
        ...
        <div class="breadcrumb-container d-flex align-items-center justify-content-between">
            <div class="d-flex align-items-center">
                <div class="breadcrumb-title pe-3">
                    ...
                    SMS Forwarder - {{ $itaggData->keyword ?? 'N/A' }}
                </div>
                &nbsp;
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">SMS Forwarder</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="config-card">
            ...
            <div class="section-content">
                ...
                <form method="POST" action="{{ route('keywords.sms-forwarder.save') }}">
                    @csrf
                    ...
                    <input type="hidden" name="module" value="SMSForwarder">

                    <div class="mb-3">
                        <label class="fw-bold">
                            When somebody sends in a message starting with "{{ $itaggData->keyword }}"
                        </label>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="fwd_mobile" class="form-control" rows="6" required>{{ old('fwd_mobile', $sms_mobile->fwd_mobile ?? '') }}</textarea>
                        @error('fwd_mobile')
                    ...
                    <div class="mb-4">
                        <label>
                            ...
                            Your current wallet level is <b>£ {{ sprintf('%.2f', $wallet_bal ?? 0) }}</b>
                        </label>
                    </div>
