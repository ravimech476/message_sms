@extends('layouts.app')
@section('title', 'Voting - SMS Expert')
    ...
    <div class="config-container">
        ...
        <div class="config-card">
            ...
            <div class="section-content">
                <p class="mb-0">
                    The Voting Module cannot be switched on whilst other Modules are enabled that can result in outbound SMS
                    (such as the <b>WAP Push responder</b> Module), as this can be potentially confusing for users.
                    <br><br>
                    You must switch off such Modules before you can enable the Voting Module.
                </p>
