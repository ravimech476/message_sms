@extends('layouts.app')
@section('title', 'Business Card - SMS Expert')
    ...
    <div class="config-container">
        ...
        <div class="config-card">
            ...
            <div class="section-content">
                <p class="mb-2">
                    <strong>The Business Card Module cannot be switched on</strong> whilst there are other Modules
                    enabled which can result in outbound SMS (such as the <b>WAP Push responder</b> Module),
                    as this can be potentially confusing for users.
                </p>

                <p class="mb-0">
                    You must switch off such Modules before you can enable the Business Card Module.
                </p>
                <br>
                <div class="d-flex gap-2">
                    <a href="{{ route('keywords.config', ['itaggId' => $itaggId, 'keyword' => $keyword]) }}"
