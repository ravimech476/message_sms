    ...
    <main class="main-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3 breadcolor" style="position: relative;">
                <div class="breadcrumb-title pe-3 title-name">Invoice Details</div>
                <div class="ps-3">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="mb-3 fw-bold theme-dependent">Order Confirmation + Invoice Details</h5>
                    <p>Thank you for ordering SMS Expert service from SMS Expert. We have just sent you a separate email
