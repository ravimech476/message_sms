    ...
    <main class="main-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3 breadcolor" style="position: relative;">
                <div class="breadcrumb-title pe-3 title-name">Create Keyword</div>
                <div class="ps-3">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div class="d-flex align-items-center">
                                    <h5 class="mb-0 fw-bold theme-dependent me-2">Create Keyword</h5>
                                </div>
                            </div>
                                ...
                                <div id="test-l-1" role="tabpanel" class="bs-stepper-pane"
                                    ...
                                    <form action="{{ route('keyword.store') }}" method="POST">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <input type="hidden" id="userid" name="userid" value="{{ $get_user_id ?? '' }}" />
                                        </div>
                                        <br>
