...
@section('title', 'Admin Login - SMS Expert')
    ...
    <div class="auth-card">
        ...
        <div class="auth-brand">
            <div class="admin-badge">
                <i class="material-icons-outlined" style="font-size: 0.9rem; margin-right: 0.3rem;">admin_panel_settings</i>
                Admin Portal
            </div>
            ...
            <p class="brand-subtitle">Administrative Control Panel for SMS Expert Platform</p>
            ...
            <div class="feature-grid">
                <div class="feature-item">
                    ...
                    <div class="feature-text">System Management</div>
                </div>
                <div class="feature-item">
                    <div class="feature-icon">
                        <i class="material-icons-outlined">people</i>
                    </div>
                    <div class="feature-text">User Administration</div>
                </div>
                <div class="feature-item">
                    <div class="feature-icon">
                        <i class="material-icons-outlined">assessment</i>
                    </div>
                    <div class="feature-text">Advanced Reports</div>
                </div>
                <div class="feature-item">
                    <div class="feature-icon">
                        <i class="material-icons-outlined">settings</i>
                    </div>
                    <div class="feature-text">Platform Settings</div>
                </div>
            </div>
        </div>
        ...
        <div class="auth-form">
            <div class="form-header">
                <h2 class="form-title">
                    <i class="material-icons-outlined admin-icon">admin_panel_settings</i>
                    Admin Access
                </h2>
                <p class="form-subtitle">Sign in to access the administrative dashboard</p>
            </div>
            ...
            <form method="POST" action="{{ route('admin.login.post') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="userName" name="userName" 
                           placeholder="Enter your admin username" required autocomplete="username">
                    @error('userName')
            ...
            {{-- <div class="customer-login-link">
                Not an admin? <a href="{{ route('showloginform') }}">Customer Login</a>
            </div> --}}
        </div>
    </div>
</div>
...
console.log('SMS Expert Admin login page loaded successfully!');
</script>
@endpush