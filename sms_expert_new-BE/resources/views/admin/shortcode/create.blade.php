    ...
    <main class="main-wrapper" id="main-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3 breadcolor" style="position: relative;">
                <div class="breadcrumb-title pe-3 title-name">Create Virtual Number</div>
                <div class="ps-3">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div class="d-flex align-items-center">
                                    <h5 class="mb-0 fw-bold theme-dependent me-2">Create Virtual Number</h5>
                                </div>
                            </div>
                            ...
                            <div class="bs-stepper-content">
                                <div id="test-l-1" role="tabpanel" class="bs-stepper-pane"
                                    ...
                                    <form action="{{ route('smsshortcodes.store') }}" method="POST">
                                        @csrf
                                        <input type="hidden" name="userid" value="{{ $userid }}">

                                        <div class="row g-3">
                                            <div class="col-12 col-lg-6">
                                                <label class="form-label fw-semibold theme-label-color">Virtual Number</label>
                                                <input type="text" name="vnumber" class="form-control"  required>
                                            </div>
                                        </div>
