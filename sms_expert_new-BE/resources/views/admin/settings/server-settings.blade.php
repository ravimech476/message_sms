...
<main class="main-wrapper" id="main-wrapper">
    <div class="main-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3 breadcolor" style="position: relative;">
            <div class="breadcrumb-title pe-3 title-name">Server Settings</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0" style="background: none;">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.settings') }}" class="text-decoration-none">Settings</a>
                        </li>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.settings.server.save') }}" method="POST">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <button type="button" class="btn btn-outline-secondary" onclick="testConnection('old_server')">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.settings.server.save') }}" method="POST">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <button type="button" class="btn btn-outline-secondary" onclick="testConnection('new_server')">
                                    <i class="material-icons-outlined me-1" style="font-size: 18px; vertical-align: middle;">power</i> Test Connection
                                </button>
                            </div>
                        </form>
