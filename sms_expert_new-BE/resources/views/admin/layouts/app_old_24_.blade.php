...
<head>
    ...
    <style>
        ...
        /* Hover effect (always apply on hover) */
        .top-header .btn-toggle a:hover,
        .top-header .btn-toggle a:focus:hover {
        ...
        .mini-sidebar .user .user-icon:focus:hover {
            /* background-color: #fd7e14; */
            color: #008cff;
            text-decoration: none;
            background-color: rgba(0, 140, 255, 0.05);
        ...
        .mini-sidebar .quick-menu .nav-link:hover,
        .mini-sidebar .quick-menu .nav-link:focus {
            color: #008cff;
            text-decoration: none;
            background-color: rgba(0, 140, 255, 0.05);
...
<body>
    ...
    <header class="top-header">
        <nav class="navbar navbar-expand align-items-center justify-content-between px-3">
            ...
            <div class="d-flex align-items-center gap-2">
                <div class="btn-toggle">
                    <a href="#offcanvasPrimaryMenu" data-bs-toggle="offcanvas" id="hoverMenuTrigger">
                        <i class="material-icons-outlined">menu</i>
                    </a>
                </div>
                <img src="{{ asset('assets/images/auth/smsexpert_cover-3.png') }}" height="24" alt="">
                {{-- <span class="crm-title text-white fw-bold fs-5">CRM</span> --}}
            </div>
          ...
          <ul class="dropdown-menu dropdown-menu-end">
              ...
              <li>
                ...
                <li class="nav-item dropdown dropdown-settings">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <!-- Theme Options -->
                        <li class="dropdown-header">Theme Options</li>
                        <li>
                            <input type="radio" class="btn-check" name="theme-options" id="LightTheme" checked>
                            <label class="dropdown-item d-flex align-items-center py-2" for="LightTheme">
                                <span class="material-icons-outlined">light_mode</span>
    ...
    <aside class="mini-sidebar">
        ...
        <div class="quick-menu" style="padding: 10px">
            <nav class="nav flex-column">
                ...
                <a class="nav-link {{ request()->routeIs('admin.users') ? 'active' : '' }}"
                    href="{{ route('admin.users') }}" title="Customers">
                    <i class="material-icons-outlined">group</i>
                </a>

                <a class="nav-link {{ request()->routeIs('admin.client.emails') ? 'active' : '' }}"
                    href="{{ route('admin.client.emails') }}" title="Customer Emails">
                    <i class="material-icons-outlined">email</i>
                </a>
                 <a class="nav-link {{ request()->routeIs('admin.virtual-numbers.index') ? 'active' : '' }}"
                    href="{{ route('admin.virtual-numbers.index') }}" title="Virtual Numbers">
                    <i class="material-icons-outlined">phone</i>
                </a>
                
                <a class="nav-link {{ request()->routeIs('admin.settings') ? 'active' : '' }}" href="{{ route('admin.settings') }}" title="Settings">
    ...
    {{-- <aside class="mini-sidebar d-flex align-items-center flex-column justify-content-between">
        ...
        <div class="quick-menu">
            <nav class="nav flex-column">
                ...
                <a class="nav-link" href="{{ route('admin.client.emails') }}"><i
    ...
    <div class="offcanvas offcanvas-start w-260" data-bs-scroll="true" tabindex="-1" id="offcanvasPrimaryMenu">
        <div class="offcanvas-header border-bottom h-70">
            <img src="{{ asset('assets/images/auth/smsexpert_cover-3.png') }}"
        ...
        <div class="offcanvas-body">
            <nav class="sidebar-nav">
                <ul class="metismenu" id="sidenav">
                    ...
                    <li>
                        <a href="{{ route('admin.client.emails') }}">
 ...
 <li>
                        <a href="{{ route('admin.virtual-numbers.index') }}">
                            <div class="parent-icon"><i class="material-icons-outlined">phone</i>
                            </div>
  ...
  <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="staticBackdrop">
    ...
    <script>
        document.getElementById('backButton').addEventListener('click', function() {
            ...
            // List of URLs that should redirect to dashboard
            ...
            try {
                ...
                // If current page is restricted → go to dashboard
                if (restrictedUrls.includes(currentPath)) {
                    window.location.href = dashboardUrl;
                } else {
                    // Non-restricted → normal back if possible
    ...
    <script>
        // Prevent Bootstrap from trying to initialize non-existent modals
        document.addEventListener('DOMContentLoaded', function() {
            // Override Bootstrap's modal auto-initialization for elements without proper modals
            const modalTriggers = document.querySelectorAll('[data-bs-toggle="modal"]');
            modalTriggers.forEach(function(trigger) {
                const targetId = trigger.getAttribute('data-bs-target');
                if (targetId && !document.querySelector(targetId)) {
                    // Remove the data-bs-toggle if modal doesn't exist
                    trigger.removeAttribute('data-bs-toggle');
                    trigger.removeAttribute('data-bs-target');
                    console.warn('Removed invalid modal trigger for:', targetId);
                }
            });
        });
    </script>
