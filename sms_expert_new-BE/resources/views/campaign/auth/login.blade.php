...
@section('title', 'Campaign Manager Login')
        ...
        <div class="auth-card">
            ...
            <div class="auth-form">
                <div class="form-header">
                    <h2 class="form-title">Campaign Access</h2>
                    <p class="form-subtitle">Enter your campaign manager credentials to access the control panel</p>
                </div>
                ...
                <form method="POST" action="{{ route('campaign.login.post') }}">
                    @csrf
                    <input type="hidden" name="request_login_type" value="campaign">
...
@push('js')
    <script>
        ...
        console.log('SMS Expert branded campaign login page loaded successfully!');
    </script>
@endpush
