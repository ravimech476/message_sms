{{-- Campaign Manager Tour Partial --}}
{{-- Include this in the campaign dashboard layout --}}
...
<script src="{{ asset('assets/js/tour/campaign-tour-steps.js') }}?v=1.3"></script>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    @php
        $autoStart = isset($showCampaignTour) && $showCampaignTour ? 'true' : 'false';
    @endphp
    ...
    if (typeof SMSTour !== 'undefined') {
        // Initialize tour
        SMSTour.init('campaign', shouldAutoStart);
    } else {
